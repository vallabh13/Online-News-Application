...
function NewsApp() {
    const apiKey = "53f19bb2b4c64aaca2a374e94a8b2451";
    const [newsList, setNewsList] = useState([]);
    const [query, setQuery] = useState('tesla');
   // const apiUrl = `https://newsapi.org/v2/everything?q=${query}&from=2022-11-29&sortBy=publishedAt&apiKey=${apiKey}`;
    const apiUrl = `https://newsapi.org/v2/everything?q=${query}&from=2023-01-12&sortBy=publishedAt&apiKey=${apiKey}`;
